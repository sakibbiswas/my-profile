...
const Navbar = () => {
    const navLi = <>
        ...
        <li className='text-xl font-semibold   hover:  transform 
         hover:scale-75 duration-300 '><Link to='/about'>About Me</Link></li>
        <li className='text-xl  font-semibold  hover:  transform 
         hover:scale-75 duration-300 '><Link to='/expertise'>Expertise</Link></li>
        <li className='text-xl font-semibold   hover: transform 
         hover:scale-75 duration-300 '><Link to='/test'>Testimonial</Link></li>
        <li className='text-xl font-semibold   hover: hover: transform 
         hover:scale-75 duration-300 '><Link to='/contact'>Contact</Link></li>
    </>
    return (

        <div>

            <div className="navbar  text-gray-800 bg-pink-100 ">
